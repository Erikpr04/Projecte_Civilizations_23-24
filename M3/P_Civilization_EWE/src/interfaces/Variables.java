...
public interface Variables {
	...
	public final int[] PLUS_ATTACK_TECHNOLOGY = {PLUS_ATTACK_SWORDSMAN_BY_TECHNOLOGY, 
			PLUS_ATTACK_SPEARMAN_BY_TECHNOLOGY, PLUS_ATTACK_CROSSBOW_BY_TECHNOLOGY,
			PLUS_ATTACK_CANNON_BY_TECHNOLOGY, PLUS_ATTACK_ARROWTOWER_BY_TECHNOLOGY,
			PLUS_ATTACK_CATAPULT_BY_TECHNOLOGY, PLUS_ATTACK_ROCKETLAUNCHERTOWER_BY_TECHNOLOGY,
			PLUS_ATTACK_MAGICIAN_BY_TECHNOLOGY};
	...
	//Array with chance generating waste of ALL units -----------------
	public final int[] CHANCE_GENERATING_WASTE_UNITS = 
		{CHANCE_GENERATNG_WASTE_SWORDSMAN,CHANCE_GENERATNG_WASTE_SPEARMAN,CHANCE_GENERATNG_WASTE_CROSSBOW,CHANCE_GENERATNG_WASTE_CANNON,
		 CHANCE_GENERATNG_WASTE_ARROWTOWER,CHANCE_GENERATNG_WASTE_CATAPULT,CHANCE_GENERATNG_WASTE_ROCKETLAUNCHERTOWER,
		 CHANCE_GENERATNG_WASTE_MAGICIAN,CHANCE_GENERATNG_WASTE_PRIEST};
	...
	public final int[] CHANCE_ATTACK_AGAIN_UNITS = 
		{CHANCE_ATTACK_AGAIN_SWORDSMAN,CHANCE_ATTACK_AGAIN_SPEARMAN,CHANCE_ATTACK_AGAIN_CROSSBOW,CHANCE_ATTACK_AGAIN_CANNON,
			CHANCE_ATTACK_AGAIN_ARROWTOWER,CHANCE_ATTACK_AGAIN_CATAPULT,CHANCE_ATTACK_AGAIN_ROCKETLAUNCHERTOWER,
			CHANCE_ATTACK_AGAIN_MAGICIAN,CHANCE_ATTACK_AGAIN_PRIEST};
