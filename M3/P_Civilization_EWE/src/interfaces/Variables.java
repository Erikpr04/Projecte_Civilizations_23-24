...
public interface Variables {
	...
	//public final String url = "jdbc:oracle:thin:@192.168.10.100:1521/orcl?serverTimezone=UTC&autoReconnect=true&useSSL=false";
	...
	public final int[] PLUS_ARMOR_TECHNOLOGY = {PLUS_ARMOR_SWORDSMAN_BY_TECHNOLOGY, PLUS_ARMOR_SPEARMAN_BY_TECHNOLOGY,
			PLUS_ARMOR_CROSSBOW_BY_TECHNOLOGY , PLUS_ARMOR_CANNON_BY_TECHNOLOGY, PLUS_ARMOR_ARROWTOWER_BY_TECHNOLOGY,
			PLUS_ARMOR_CATAPULT_BY_TECHNOLOGY, PLUS_ARMOR_ROCKETLAUNCHERTOWER_BY_TECHNOLOGY, 0, 0};
	...
	public final int[] PLUS_ATTACK_TECHNOLOGY = {PLUS_ATTACK_SWORDSMAN_BY_TECHNOLOGY, 
			...
			PLUS_ATTACK_MAGICIAN_BY_TECHNOLOGY, 0};
